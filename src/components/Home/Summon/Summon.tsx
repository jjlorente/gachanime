        ...
        currentSection.map((section:any, index:any) => {
          return (
            <div className='section-summon' key={index} style={{ backgroundImage: section.backgroundImage}}>
              ...
              <ModalConfirm openModalConfirm={openModalConfirm} setOpenModalConfirm={setOpenModalConfirm} modalConfirmType={modalConfirmType} animeType={animeType} gachas={gachas} throws={throws}/>
            </div>
